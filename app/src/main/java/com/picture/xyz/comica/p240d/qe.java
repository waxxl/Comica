...
import com.picture.xyz.comica.p241e.p458d.p459a.nc;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.f0 */
public class qe extends jm {

    /* renamed from: c */
    private static String f39397c = "marker";

    public qe(Context context) {
        this.f39361b = f39397c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        nc bVar = new nc(context);
        this.f39360a = bVar;
        return bVar;
    }
