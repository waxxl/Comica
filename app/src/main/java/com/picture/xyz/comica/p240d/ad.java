...
import com.picture.xyz.comica.p241e.p458d.p460a0.dc;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.i0 */
public class ad extends jm {

    /* renamed from: c */
    private static String f39402c = "cartoon";

    public ad(Context context) {
        this.f39361b = f39402c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        dc aVar = new dc(context);
        this.f39360a = aVar;
        return aVar;
    }
