...
import com.picture.xyz.comica.p241e.p458d.p486z.ai;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.d */
public class tn extends jm {

    /* renamed from: c */
    private static String f39393c = "draw";

    public tn(Context context) {
        this.f39361b = f39393c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        ai aVar = new ai(context);
        this.f39360a = aVar;
        return aVar;
    }
