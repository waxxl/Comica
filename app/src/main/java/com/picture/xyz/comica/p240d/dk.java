...
import com.picture.xyz.comica.p241e.p458d.p473m.ha;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.g */
public class dk extends jm {

    /* renamed from: c */
    private static String f39398c = "track";

    public dk(Context context) {
        this.f39361b = f39398c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        ha bVar = new ha(context);
        this.f39360a = bVar;
        return bVar;
    }
