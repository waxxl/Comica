...
import com.picture.xyz.comica.p241e.p458d.p464e.ya;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.m */
public class mo extends jm {

    /* renamed from: c */
    private static String f39410c = "stamp";

    public mo(Context context) {
        this.f39361b = f39410c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        ya bVar = new ya(context);
        this.f39360a = bVar;
        return bVar;
    }
