...
import com.picture.xyz.comica.p241e.p458d.p461b.qb;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.d0 */
public class qf extends jm {

    /* renamed from: c */
    private static String f39394c = "money";

    public qf(Context context) {
        this.f39361b = f39394c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        qb aVar = new qb(context);
        this.f39360a = aVar;
        return aVar;
    }
