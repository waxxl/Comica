...
import com.picture.xyz.comica.p241e.p458d.p471k.zc;
import com.picture.xyz.comica.p246gr.gamebrain.comica.R;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.n */
public class cj extends jm {

    /* renamed from: c */
    private static String f39411c = "cloud";

    public cj(Context context) {
        this.f39361b = f39411c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        zc aVar = new zc(context, R.drawable.shadows);
        this.f39360a = aVar;
        return aVar;
    }
