...
import com.picture.xyz.comica.p241e.p458d.p467g.db;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.j0 */
public class of extends jm {

    /* renamed from: c */
    private static String f39404c = "sketch";

    public of(Context context) {
        this.f39361b = f39404c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        db bVar = new db(context);
        this.f39360a = bVar;
        return bVar;
    }
