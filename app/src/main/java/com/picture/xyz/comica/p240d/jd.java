...
import com.picture.xyz.comica.p241e.p458d.p465f.p466a.rc;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.g0 */
public class jd extends jm {

    /* renamed from: c */
    private static String f39399c = "pen";

    public jd(Context context) {
        this.f39361b = f39399c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        rc aVar = new rc(context);
        this.f39360a = aVar;
        return aVar;
    }
