...
import com.picture.xyz.comica.p241e.p458d.p463d.aa;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.c0 */
public class xj extends jm {

    /* renamed from: c */
    private static String f39392c = "stripe";

    public xj(Context context) {
        this.f39361b = f39392c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        aa bVar = new aa(context);
        this.f39360a = bVar;
        return bVar;
    }
