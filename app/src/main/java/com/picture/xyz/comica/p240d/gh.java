...
import com.picture.xyz.comica.p241e.p458d.p472l.vc;
import com.picture.xyz.comica.imageprocessing.p253c.BasicFilter;

/* renamed from: d.u */
public class gh extends jm {

    /* renamed from: c */
    private static String f39418c = "comic";

    public gh(Context context) {
        this.f39361b = f39418c;
    }

    /* renamed from: d */
    public BasicFilter mo51861d(Context context) {
        vc aVar = new vc(context);
        this.f39360a = aVar;
        return aVar;
    }
